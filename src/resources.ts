...
// All 11 products with pricing and descriptions
const PRODUCTS = [
 ...
 */
export function createProductResources(): Resource[] {
  ...
  // Add individual product resources
 ...
 */
export function getCatalogResource(uri: string): Resource | null {
  ...
  // Return the full resource with the actual content
  // The mimeType and name are already set
  return resource;
}